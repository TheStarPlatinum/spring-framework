 ...
 * {@code @PersistenceContext} are aware of thread-bound bean managers and participate
 ...
 * Connection, not to the JPA EntityManager and its cached bean objects and related
...
public class JpaTransactionManager extends AbstractPlatformTransactionManager
	...
	protected void doBegin(Object transaction, TransactionDefinition definition) {
		...
		try {
			...
			// Bind the bean manager holder to the thread.
	...
	protected void doCleanupAfterCompletion(Object transaction) {
		...
		// Remove the bean manager holder from the thread, if still there.
		...
		// Remove the bean manager holder from the thread.
		if (txObject.isNewEntityManagerHolder()) {
			EntityManager em = txObject.getEntityManagerHolder().getEntityManager();
			if (logger.isDebugEnabled()) {
